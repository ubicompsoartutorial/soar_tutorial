...
from autoencoder.model import Classifier
from time import time
from torch import optim
from torch.optim.lr_scheduler import StepLR
from autoencoder.utils import save_meter, compute_best_metrics, compute_metrics, \
...
def evaluate_with_classifier(args=None):
    """
    Evaluating the performance of the trained Autoencoder models with a
    classifier
